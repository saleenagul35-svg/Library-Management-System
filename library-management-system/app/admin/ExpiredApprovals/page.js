...
function TableRow({ record, index }) {
  return (
    ...
    >
      ...
      {/* Status */}
      <td className="px-5 py-4">
        <span className="inline-flex items-center gap-1 rounded-full px-2.5 py-0.5 text-[11px] font-semibold border  bg-red-100 text-red-700 border border-red-200">
        ...
        <div>
          <div className="flex items-center gap-3 mb-1">
            <div className="flex h-9 w-9 items-center justify-center rounded-xl bg-primary/10">
              <TimerOff size={18} className="text-primary" strokeWidth={1.75} />
            </div>
          ...
          <p className="text-sm ml-12 text-primary-800/45">
            {records.length} approval{records.length !== 1 ? 's' : ''} expired
          </p>
        </div>
